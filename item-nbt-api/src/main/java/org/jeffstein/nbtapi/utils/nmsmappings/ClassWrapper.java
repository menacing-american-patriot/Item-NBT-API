...
import static org.jeffstein.nbtapi.utils.MinecraftVersion.getLogger;
...
public enum ClassWrapper {
        ...
        NMS_TAGTYPE(PackageWrapper.NMS, "NBTTagType", MinecraftVersion.MC1_21_R4, null, "net.minecraft.nbt",
        ...
        NMS_REGISTRYSIMPLE(PackageWrapper.NMS, "RegistrySimple", MinecraftVersion.MC1_11_R1,
        ...
        ClassWrapper(PackageWrapper packageId, String clazzName, MinecraftVersion from, MinecraftVersion to,
                ...
                try {
                        ...
                        if (MinecraftVersion.isAtLeastVersion(MinecraftVersion.MC1_17_R1) && mojangMap != null) {
                                ...
                                clazz = Class.forName(
                                                Bukkit.getServer().getClass().getPackage().getName() + "." + clazzName);
                        } else {
                        ...
                        getLogger().log(Level.WARNING,
                                        "[NBTAPI] Error while trying to resolve the class '" + clazzName + "'!", ex);
                }
        }
