...
public class MojangToMapping {
    ...
    private static Map<String, String> MC1_21R4 = new HashMap<String, String>() {

        {
            ...
            put("net.minecraft.world.item.ItemStack#parse(net.minecraft.core.HolderLookup$Provider,net.minecraft.nbt.Tag)",
                    "a");
            put("net.minecraft.world.item.ItemStack#CODEC", "b");
        }
    ...
    private static Map<String, String> MC1_21R5 = new HashMap<String, String>() {
        ...
        {
            putAll(MC1_21R3);
            put("net.minecraft.core.HolderLookup$Provider#createSerializationContext(com.mojang.serialization.DynamicOps)",
                    "a");
            put("net.minecraft.nbt.CompoundTag#getByteArray(java.lang.String)", "j");
            put("net.minecraft.nbt.CompoundTag#getDouble(java.lang.String)", "h");
            ...
            put("net.minecraft.world.level.block.entity.BlockEntity#saveWithId(net.minecraft.world.level.storage.ValueOutput)",
                    "d");
            put("net.minecraft.world.level.block.entity.BlockEntity#loadWithComponents(net.minecraft.world.level.storage.ValueInput)",
                    "b");
            put("net.minecraft.world.level.storage.TagValueInput#create(net.minecraft.util.ProblemReporter,net.minecraft.core.HolderLookup$Provider,net.minecraft.nbt.CompoundTag)",
                    "a");
            put("net.minecraft.world.level.storage.TagValueOutput#createWithContext(net.minecraft.util.ProblemReporter,net.minecraft.core.HolderLookup$Provider)",
                    "a");
    ...
    public static Map<String, String> getMapping() {
        switch (MinecraftVersion.getVersion()) {
            case MC1_21_R7:
                return MC1_21R6; // Use MC1_21R6 mappings for MC1_21_R7 as they should be compatible
            case MC1_21_R6:
                return MC1_21R6;
            case MC1_21_R5:
                return MC1_21R5;
