package org.jeffstein.nbtapi.utils.nmsmappings;
...
public enum ReflectionMethod {
        ...
        COMPOUND_SET_UUID(ClassWrapper.NMS_NBTTAGCOMPOUND, new Class[] { String.class, UUID.class },
                        MinecraftVersion.MC1_16_R1, MinecraftVersion.MC1_21_R3,
        ...
        COMPOUND_GET_LIST_LEGACY(ClassWrapper.NMS_NBTTAGCOMPOUND, new Class[] { String.class, int.class },
                        MinecraftVersion.MC1_7_R4, MinecraftVersion.MC1_21_R3,
        ...
        COMPOUND_OWN_TYPE_LEGACY(ClassWrapper.NMS_NBTBASE, new Class[] {}, MinecraftVersion.MC1_7_R4,
        ...
        COMPOUND_GET_LONGARRAY(ClassWrapper.NMS_NBTTAGCOMPOUND, new Class[] { String.class },
        ...
        NMSITEM_SAVE(ClassWrapper.NMS_ITEMSTACK, new Class[] { ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz() },
                        MinecraftVersion.MC1_7_R4, MinecraftVersion.MC1_20_R3,
        ...
        NMSITEM_CREATESTACK(ClassWrapper.NMS_ITEMSTACK, new Class[] { ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz() },
                        MinecraftVersion.MC1_7_R4, MinecraftVersion.MC1_10_R1,
        ...
        // FIXME ?!?
        // LISTCOMPOUND_GET_KEYS(ClassWrapper.NMS_NBTTAGCOMPOUND, new Class[] {},
        // MinecraftVersion.MC1_7_R4,
        // new Since(MinecraftVersion.MC1_7_R4, "c"), new
        // Since(MinecraftVersion.MC1_13_R1, "getKeys"),
        // new Since(MinecraftVersion.MC1_18_R1, "getAllKeys()")),
        ...
        LEGACY_LIST_ADD(ClassWrapper.NMS_NBTTAGLIST, new Class[] { ClassWrapper.NMS_NBTBASE.getClazz() },
                        MinecraftVersion.MC1_7_R4, MinecraftVersion.MC1_13_R2,
        ...
        NMS_WORLD_GET_TILEENTITY(ClassWrapper.NMS_WORLDSERVER,
        ...
        NMS_WORLD_REMOVE_TILEENTITY(ClassWrapper.NMS_WORLDSERVER,
                        new Class[] { ClassWrapper.NMS_BLOCKPOSITION.getClazz() },
                        MinecraftVersion.MC1_8_R3, MinecraftVersion.MC1_17_R1,
        ...
        TILEENTITY_LOAD_LEGACY191(ClassWrapper.NMS_TILEENTITY,
                        new Class[] { ClassWrapper.NMS_MINECRAFTSERVER.getClazz(),
                                        ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz() },
                        MinecraftVersion.MC1_9_R1, MinecraftVersion.MC1_9_R1,
                        new Since(MinecraftVersion.MC1_9_R1, "a")),
        TILEENTITY_LOAD_LEGACY183(ClassWrapper.NMS_TILEENTITY,
        ...
        TILEENTITY_LOAD_LEGACY1121(ClassWrapper.NMS_TILEENTITY,
                        ...
                        MinecraftVersion.MC1_10_R1, MinecraftVersion.MC1_12_R1,
                        new Since(MinecraftVersion.MC1_10_R1, "a"),
                        new Since(MinecraftVersion.MC1_12_R1, "create")),
        TILEENTITY_LOAD_LEGACY1151(ClassWrapper.NMS_TILEENTITY,
                        new Class[] { ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz() },
                        MinecraftVersion.MC1_13_R1, MinecraftVersion.MC1_15_R1,
                        new Since(MinecraftVersion.MC1_12_R1, "create")),
        TILEENTITY_LOAD(ClassWrapper.NMS_TILEENTITY,
                        new Class[] { ClassWrapper.NMS_IBLOCKDATA.getClazz(),
                                        ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz() },
                        MinecraftVersion.MC1_16_R1, MinecraftVersion.MC1_16_R3,
        ...
        TILEENTITY_GET_NBT(ClassWrapper.NMS_TILEENTITY, new Class[] { ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz() },
                        MinecraftVersion.MC1_7_R4, MinecraftVersion.MC1_17_R1,
        ...
        TILEENTITY_SET_NBT(ClassWrapper.NMS_TILEENTITY, new Class[] { ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz() },
                        MinecraftVersion.MC1_17_R1, MinecraftVersion.MC1_20_R4,
                        new Since(MinecraftVersion.MC1_16_R1, "load"),
        ...
        NMS_ENTITY_SET_NBT(ClassWrapper.NMS_ENTITY, new Class[] { ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz() },
                        MinecraftVersion.MC1_7_R4, MinecraftVersion.MC1_21_R4,
        ...
        NBTFILE_READ(ClassWrapper.NMS_NBTCOMPRESSEDSTREAMTOOLS, new Class[] { InputStream.class },
                        MinecraftVersion.MC1_7_R4, MinecraftVersion.MC1_20_R2,
        ...
        REGISTRY_SET(ClassWrapper.NMS_REGISTRYSIMPLE, new Class[] { Object.class, Object.class },
                        MinecraftVersion.MC1_11_R1, MinecraftVersion.MC1_13_R1,
                        new Since(MinecraftVersion.MC1_11_R1, "a")),
        REGISTRY_GET_INVERSE(ClassWrapper.NMS_REGISTRYMATERIALS, new Class[] { Object.class },
        ...
        REGISTRYMATERIALS_GET(ClassWrapper.NMS_REGISTRYMATERIALS,
                        new Class[] { ClassWrapper.NMS_MINECRAFTKEY.getClazz() },
                        MinecraftVersion.MC1_13_R1, MinecraftVersion.MC1_17_R1,
                        new Since(MinecraftVersion.MC1_13_R1, "get")),
        REGISTRYMATERIALS_GETKEY(ClassWrapper.NMS_REGISTRYMATERIALS, new Class[] { Object.class },
                        MinecraftVersion.MC1_13_R2, MinecraftVersion.MC1_17_R1,
        ...
        GAMEPROFILE_SERIALIZE(ClassWrapper.NMS_GAMEPROFILESERIALIZER,
                        ...
                        MinecraftVersion.MC1_8_R3, MinecraftVersion.MC1_20_R3,
        ...
        // 1.20.5+ Stuff
        NMSDATACOMPONENTHOLDER_GET(ClassWrapper.NMS_DATACOMPONENTHOLDER,
                        new Class[] { ClassWrapper.NMS_DATACOMPONENTTYPE.getClazz() }, MinecraftVersion.MC1_20_R4,
        ...
        NMSITEM_SET(ClassWrapper.NMS_ITEMSTACK,
        ...
        TILEENTITY_GET_NBT_1205(ClassWrapper.NMS_TILEENTITY, new Class[] { ClassWrapper.NMS_PROVIDER.getClazz() },
                        MinecraftVersion.MC1_20_R4, MinecraftVersion.MC1_21_R4,
                        new Since(MinecraftVersion.MC1_20_R4, "saveWithId(net.minecraft.core.HolderLookup$Provider)")),
        TILEENTITY_SET_NBT_1205(ClassWrapper.NMS_TILEENTITY,
                        new Class[] { ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz(),
        ...
        // 1.21.6 Stuff
        GET_SERIALIZATION_CONTEXT(ClassWrapper.NMS_PROVIDER, new Class[] { ClassWrapper.NMS_DYNAMICOPS.getClazz() },
                        MinecraftVersion.MC1_21_R5,
                        new Since(MinecraftVersion.MC1_21_R5,
                                        "createSerializationContext(com.mojang.serialization.DynamicOps)")),
        NMS_GET_TAG_VALUE_INPUT(ClassWrapper.NMS_TAG_VALUE_INPUT,
                        new Class[] { ClassWrapper.NMS_PROBLEM_REPORTER.getClazz(),
                                        ClassWrapper.NMS_PROVIDER.getClazz(),
                                        ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz() },
                        MinecraftVersion.MC1_21_R5,
                        new Since(MinecraftVersion.MC1_21_R5,
                                        "create(net.minecraft.util.ProblemReporter,net.minecraft.core.HolderLookup$Provider,net.minecraft.nbt.CompoundTag)")),
        NMS_GET_TAG_VALUE_OUTPUT(ClassWrapper.NMS_TAG_VALUE_OUTPUT,
                        new Class[] { ClassWrapper.NMS_PROBLEM_REPORTER.getClazz(),
                                        ClassWrapper.NMS_PROVIDER.getClazz() },
                        MinecraftVersion.MC1_21_R5,
                        new Since(MinecraftVersion.MC1_21_R5,
                                        "createWithContext(net.minecraft.util.ProblemReporter,net.minecraft.core.HolderLookup$Provider)")),
        NMS_TAG_VALUE_OUTPUT_TO_TAG_COMPOUND(ClassWrapper.NMS_TAG_VALUE_OUTPUT, new Class[] {},
                        MinecraftVersion.MC1_21_R5,
                        new Since(MinecraftVersion.MC1_21_R5, "buildResult()")),
        NMS_ENTITY_SET_NBT_1216(ClassWrapper.NMS_ENTITY, new Class[] { ClassWrapper.NMS_VALUE_INPUT.getClazz() },
                        MinecraftVersion.MC1_21_R5,
                        new Since(MinecraftVersion.MC1_21_R5, "load(net.minecraft.world.level.storage.ValueInput)")),
        NMS_ENTITY_GET_NBT_1216(ClassWrapper.NMS_ENTITY, new Class[] { ClassWrapper.NMS_VALUE_OUTPUT.getClazz() },
                        MinecraftVersion.MC1_21_R5,
                        new Since(MinecraftVersion.MC1_21_R5,
                                        "saveWithoutId(net.minecraft.world.level.storage.ValueOutput)")),

        TILEENTITY_GET_NBT_1216(ClassWrapper.NMS_TILEENTITY, new Class[] { ClassWrapper.NMS_VALUE_OUTPUT.getClazz() },
                        MinecraftVersion.MC1_21_R5,
                        new Since(MinecraftVersion.MC1_21_R5,
                                        "saveWithId(net.minecraft.world.level.storage.ValueOutput)")),
        TILEENTITY_SET_NBT_1216(ClassWrapper.NMS_TILEENTITY, new Class[] { ClassWrapper.NMS_VALUE_INPUT.getClazz() },
                        MinecraftVersion.MC1_21_R5,
                        new Since(MinecraftVersion.MC1_21_R5,
                                        "loadWithComponents(net.minecraft.world.level.storage.ValueInput)")),
                                        ;
        ...
        ReflectionMethod(ClassWrapper targetClass, Class<?>[] args, MinecraftVersion addedSince,
                ...
                boolean specialCase = (MinecraftVersion.isForgePresent() && this.name().equals("COMPOUND_MERGE")
                                && MinecraftVersion.getVersion() == MinecraftVersion.MC1_7_R4); // COMPOUND_MERGE is
                                                                                                // only present on
                                                                                                // Crucible, not on
                                                                                                // vanilla 1.7.10
                ...
                try {
                        if (MinecraftVersion.isForgePresent()
                                ...
                                targetMethodName = Forge1710Mappings.getMethodMapping().getOrDefault(this.name(),
                                                targetMethodName);
                        ...
                        try {
                                ...
                                MinecraftVersion.getLogger()
                                                .warning("[NBTAPI] Unable to find the method '" + targetMethodName
                                                                + "' in '"
                                                                + (targetClass.getClazz() == null
                                                                                ? targetClass.getMojangName()
                                                                                : targetClass.getClazz()
                                                                                                .getSimpleName())
                                                                + "' Args: " + Arrays.toString(args) + " Enum: "
                                                                + this); // NOSONAR This gets loaded
        ...
        public Object run(Object target, Object... args) {
                ...
                try {
                        ...
                        throw new NbtApiException("Error while calling the method '" + methodName + "', loaded: "
                                        + loaded
                                        + ", Enum: " + this + ", Passed Class: "
                                        + (target == null ? "null" : target.getClass()) + " Args: "
