...
import org.jeffstein.nbtapi.NBTReflectionUtil;
...
public class DataFixerUtil {
    ...
    public static final int VERSION1_21R7 = 4556;
    // There was a mixup between version numbers and revisions, kept for
    // compatibility, use the above revision numbers
    @Deprecated
    ...
    // the 1.21 versions use Revision instead of patch versions, unlike the other
    // above. kept for compatibility
    @Deprecated
    ...
    public static Object fixUpRawItemData(Object nbt, int fromVersion, int toVersion)
        ...
        TypeReference itemStackReference = (TypeReference) ReflectionUtil
                .getMappedField(ClassWrapper.NMS_REFERENCES.getClazz(),
                        "net.minecraft.util.datafix.fixes.References#ITEM_STACK")
                .get(null);
        DynamicOps<Object> nbtOps = (DynamicOps<Object>) ReflectionUtil
                .getMappedField(ClassWrapper.NMS_NBTOPS.getClazz(), "net.minecraft.nbt.NbtOps#INSTANCE").get(null);
