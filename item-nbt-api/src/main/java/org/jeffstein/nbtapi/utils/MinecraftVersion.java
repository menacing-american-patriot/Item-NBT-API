...
public enum MinecraftVersion {
    ...
    private static void init() {
        ...
        if (!disablePackageWarning && !"NBTAPI".equals(VersionChecker.getPlugin())) { // we are not the nbtapi, check
            ...
            if (!"org.jeffstein.nbtapi.utils".equals(reservedPackage)) {
                logger.warning(
                        "#########################################- NBTAPI -#########################################");
                logger.warning(
            ...
            if (MinecraftVersion.class.getPackage().getName().equals("org.jeffstein.nbtapi.utils")) {
                logger.warning(
                        "#########################################- NBTAPI -#########################################");
                logger.warning(
                        "The NBT-API inside " + VersionChecker.getPlugin()
                                + " is located at 'org.jeffstein.nbtapi.utils'!");
                logger.warning(
