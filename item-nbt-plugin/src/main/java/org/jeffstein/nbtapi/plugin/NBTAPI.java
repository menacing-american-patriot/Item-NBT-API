package org.jeffstein.nbtapi.plugin;
...
import org.jeffstein.nbtapi.utils.VersionChecker;
import org.jeffstein.nbtapi.utils.nmsmappings.ClassWrapper;
import org.jeffstein.nbtapi.utils.nmsmappings.ReflectionMethod;
import org.jeffstein.nbtapi.plugin.tests.GameprofileTest;
import org.jeffstein.nbtapi.plugin.tests.NBTFileTest;
import org.jeffstein.nbtapi.plugin.tests.blocks.BlockNBTTest;
import org.jeffstein.nbtapi.plugin.tests.chunks.ChunkNBTPersistentTest;
import org.jeffstein.nbtapi.plugin.tests.compounds.CompoundDifferenceTest;
import org.jeffstein.nbtapi.plugin.tests.compounds.EnumTest;
import org.jeffstein.nbtapi.plugin.tests.compounds.EqualsTest;
import org.jeffstein.nbtapi.plugin.tests.compounds.ForEachTest;
import org.jeffstein.nbtapi.plugin.tests.compounds.GetterSetterTest;
import org.jeffstein.nbtapi.plugin.tests.compounds.InterfaceTest;
import org.jeffstein.nbtapi.plugin.tests.compounds.IteratorTest;
import org.jeffstein.nbtapi.plugin.tests.compounds.ListTest;
import org.jeffstein.nbtapi.plugin.tests.compounds.LongArrayTest;
import org.jeffstein.nbtapi.plugin.tests.compounds.MergeTest;
import org.jeffstein.nbtapi.plugin.tests.compounds.ModernSubCompoundsTest;
import org.jeffstein.nbtapi.plugin.tests.compounds.RemovingKeys;
import org.jeffstein.nbtapi.plugin.tests.compounds.ResolveTest;
import org.jeffstein.nbtapi.plugin.tests.compounds.StreamTest;
import org.jeffstein.nbtapi.plugin.tests.compounds.SubCompoundsTest;
import org.jeffstein.nbtapi.plugin.tests.compounds.TypeTest;
import org.jeffstein.nbtapi.plugin.tests.entities.EntityCustomNbtPersistentTest;
import org.jeffstein.nbtapi.plugin.tests.entities.EntityTest;
import org.jeffstein.nbtapi.plugin.tests.items.ComponentsTest;
import org.jeffstein.nbtapi.plugin.tests.items.DirectApplyMetaTest;
import org.jeffstein.nbtapi.plugin.tests.items.DirectApplyTest;
import org.jeffstein.nbtapi.plugin.tests.items.EmptyItemTest;
import org.jeffstein.nbtapi.plugin.tests.items.ItemConversionTest;
import org.jeffstein.nbtapi.plugin.tests.items.ItemJsonTest;
import org.jeffstein.nbtapi.plugin.tests.items.ItemMergingTest;
import org.jeffstein.nbtapi.plugin.tests.items.ItemStackConversionTest;
import org.jeffstein.nbtapi.plugin.tests.items.LegacyItemTest;
import org.jeffstein.nbtapi.plugin.tests.items.MetaTest;
import org.jeffstein.nbtapi.plugin.tests.items.NBTModifyItemTest;
import org.jeffstein.nbtapi.plugin.tests.items.SmuggleTest;
import org.jeffstein.nbtapi.plugin.tests.proxy.SimpleProxyTest;
import org.jeffstein.nbtapi.plugin.tests.tiles.TileTest;
import org.jeffstein.nbtapi.plugin.tests.tiles.TilesCustomNBTPersistentTest;

public class NBTAPI extends JavaPlugin {

    private boolean compatible = true;
    private List<org.jeffstein.nbtapi.plugin.tests.Test> apiTests = new ArrayList<>();
    ...
    public void onEnable() {
        ...
        Map<org.jeffstein.nbtapi.plugin.tests.Test, Exception> results = new HashMap<>();
        for (org.jeffstein.nbtapi.plugin.tests.Test test : apiTests) {
            try {
                test.test();
        ...
        for (Entry<org.jeffstein.nbtapi.plugin.tests.Test, Exception> entry : results.entrySet()) {
